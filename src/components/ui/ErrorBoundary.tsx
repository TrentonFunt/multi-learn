      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-bg-primary px-4">
          <div className="max-w-md w-full text-center">
            <div className="bg-bg-secondary rounded-lg shadow-lg p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-hover transition-colors"
                >
                ...
                <Link
                  to="/"
                  className="flex items-center justify-center gap-2 bg-bg-primary text-text-primary border border-border-primary px-6 py-3 rounded-lg font-semibold hover:bg-bg-secondary transition-colors"
                >
